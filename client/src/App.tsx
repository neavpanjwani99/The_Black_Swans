...
function App() {
  ...
  const [chatHistory, setChatHistory] = useState<ChatMessage[]>([
    {
      sender: 'ai',
      text: 'DRISHTI Conversational Engine Ready. Ask any query about FIRs, suspects, vehicles, or crime metrics across Karnataka State Police records.'
    }
  ]);
      ...
      <aside className="app-sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <div className={`nav-item ${activeTab === 'similarity' ? 'active' : ''}`} onClick={() => setActiveTab('similarity')}>
            <span className="nav-icon">⚖️</span> Modus Operandi Linkage
          </div>
          <div className={`nav-item ${activeTab === 'graph' ? 'active' : ''}`} onClick={() => setActiveTab('graph')}>
            <span className="nav-icon">🕸️</span> Network Connection Graph
          </div>
        </nav>
        <div className="sidebar-footer">
          <p>KSP Crime Analytics Platform</p>
          <p style={{ marginTop: '4px' }}>v1.0.0 (Catalyst Native)</p>
        </div>
      </aside>
        ...
        <header className="app-header">
          <div className="header-title-section">
            <h2>
              ...
              {activeTab === 'chat' && 'Intelligent Conversational AI Assistant'}
            ...
            <p>Karnataka State Police — Crime Intelligence & Analytics System</p>
          </div>
        ...
        <div className="content-viewport">
              ...
              <div className="metrics-row">
                <div className="metric-card">
                  <div className="metric-info">
                    ...
                    <div className="metric-delta delta-up">▲ 12% vs last month</div>
                  </div>
                  <div className="metric-icon-container" style={{ background: 'rgba(59, 130, 246, 0.1)', color: 'var(--accent-blue)' }}>📂</div>
                </div>
                ...
                <div className="metric-card">
                  <div className="metric-info">
                    ...
                    <div className="metric-delta delta-down">▼ 4 active surges</div>
                  </div>
                  <div className="metric-icon-container" style={{ background: 'rgba(244, 63, 94, 0.1)', color: 'var(--accent-rose)' }}>🚨</div>
                </div>
                ...
                <div className="metric-card">
                  <div className="metric-info">
                    ...
                    <div className="metric-delta delta-up">▲ MG Road Corridor</div>
                  </div>
                  <div className="metric-icon-container" style={{ background: 'rgba(245, 158, 11, 0.1)', color: 'var(--accent-amber)' }}>📈</div>
                </div>
                ...
                <div className="metric-card">
                  <div className="metric-info">
                    ...
                    <div className="metric-delta delta-up">▲ 231 resolved today</div>
                  </div>
                  <div className="metric-icon-container" style={{ background: 'rgba(16, 185, 129, 0.1)', color: 'var(--accent-emerald)' }}>🧬</div>
                </div>
              </div>
              ...
              <div className="dashboard-split-row">
                ...
                <div className="dashboard-card">
                  <div className="card-header">
                    <h3 className="card-title">🔮 Time Series Trend Forecasting (AI #4)</h3>
                ...
                <div className="dashboard-card">
                  <div className="card-header">
                    <h3 className="card-title">🚨 Real-time Anomaly Signals (AI #5)</h3>
                  </div>
                  {dashboardLoading ? (
                    <div style={{ display: 'flex', justifyContent: 'center', padding: '40px' }}><div className="spinner"></div></div>
                  ) : (
                      ...
                      {anomalies.map((a, i) => (
                        <div key={i} className="anomaly-alert-item" style={{ borderLeftColor: a.acknowledged ? 'var(--accent-emerald)' : 'var(--accent-rose)', opacity: a.acknowledged ? 0.6 : 1 }}>
                          <div className="anomaly-header">
                            <span className="anomaly-title" style={{ color: a.acknowledged ? 'var(--accent-emerald)' : '#fca5a5' }}>
                              {a.station} &bull; {a.crimeType}
                            </span>
                            <span className="anomaly-time">3h overnight window</span>
                          </div>
                          <div className="anomaly-body">
                            Registered <strong>{a.firCountLast3Hours} cases</strong> vs historical mean of {a.historicalAverage}.
                            Spike is <strong>+{a.deviationPercentage}%</strong> above normal.
                          </div>
            ...
            <div className="chat-container">
              ...
              <div className="chat-messages-pane">
                <div className="chat-header">
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <div>
                      <h3 style={{ fontSize: '14px', fontWeight: 600 }}>CCTNS QuickML Vector-RAG</h3>
                      <p style={{ fontSize: '11px', color: 'var(--text-secondary)' }}>Answers sourced and cited directly from FIR database</p>
                    </div>
                  </div>
                ...
                <div className="chat-body">
                        ...
                        <div className="citations-list">
                          ...
                          {m.citations.map((c, idx) => (
                            <a href="#" key={idx} className="citation-item" onClick={(e) => { e.preventDefault(); setActiveTab('ocr'); }}>
                              📄 {c.id} &bull; {c.station} &bull; {c.type} ({c.date})
                            </a>
                          ))}
                        </div>
                      )}
                  ...
                  {chatLoading && (
                    <div className="chat-bubble ai" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 16px' }}>
                      ...
                      <span>Retrieving chunks & generating cited answer...</span>
                    </div>
                  )}
                </div>
                ...
                <div className="chat-footer">
                  <form onSubmit={handleChatSubmit} className="chat-input-form">
                    <input
                      ...
                      placeholder="Ask anything (e.g. 'Show burglaries in Banaswadi with co-accused' or in Kannada)..."
                      value={chatInput}
              ...
              <div className="chat-sidebar-pane">
                <h4 style={{ fontSize: '13px', fontWeight: 600, color: 'var(--text-primary)', borderBottom: '1px solid var(--card-border)', paddingBottom: '8px' }}>
                  💡 Test Prompt Matrix (SRS Demo Flow)
                </h4>
                <p style={{ fontSize: '11px', color: 'var(--text-secondary)' }}>Click any prompt below to automatically query the RAG system and carry context:</p>
                ...
                <div style={{ marginTop: 'auto', background: 'rgba(59, 130, 246, 0.05)', border: '1px solid rgba(59, 130, 246, 0.2)', padding: '12px', borderRadius: '8px', fontSize: '12px' }}>
                  <p style={{ fontWeight: 600, color: 'var(--accent-cyan)', marginBottom: '4px' }}>🛡️ Governance Compliance</p>
                  Every query is logged to the immutable <code>audit_event</code> ledger database, recording user credentials, timestamp, and accessed document references.
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'ocr' && (
            <div className="ocr-split">
              ...
              <div className="ocr-pane">
                <h3 style={{ fontSize: '16px', fontWeight: 600 }}>📁 Scanned Kannada FIR Document Ingest (AI #2)</h3>
                <p style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>Convert Kannada script handwriting scans or paper PDFs into indexable English-transcribed texts.</p>
                
                <div className="dropzone" onClick={handleOcrTrigger}>
                  <div className="dropzone-icon">📄</div>
                  <p style={{ fontWeight: 500 }}>Upload scanned FIR (PDF/JPG)</p>
                  <p style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Drag files here or click to simulate upload</p>
                </div>

                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  <label style={{ fontSize: '12px', fontWeight: 500, color: 'var(--text-secondary)' }}>Raw Text Input (Pre-loaded Sample):</label>
                  <textarea
                    className="textarea-input"
                    value={ocrText}
                    onChange={(e) => setOcrText(e.target.value)}
                    placeholder="Enter document text manually, or click 'Simulate OCR Scanner' to pull from Kannada scanner..."
                  />
                </div>

                <button className="btn btn-primary" onClick={handleOcrTrigger} disabled={ocrLoading} style={{ justifyContent: 'center' }}>
                  {ocrLoading ? <span className="spinner"></span> : 'Simulate OCR Scanner & NER Parser'}
                </button>
              </div>

              {/* Right pane: Results */}
              <div className="ocr-pane">
                <h3 style={{ fontSize: '16px', fontWeight: 600 }}>🧬 Entity Recognition & Linking Analysis (AI #3)</h3>
                ...
                {ocrResult ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <div>
                      ...
                      <div style={{ background: 'rgba(15, 23, 42, 0.3)', padding: '12px', borderRadius: '8px', border: '1px solid var(--card-border)', lineHeight: '1.8', fontSize: '13px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flexGrow: 1, color: 'var(--text-muted)' }}>
                    <span>Upload a scanned document or trigger scanner to see extracted text and entities.</span>
                  </div>
                )}
              </div>
            </div>
          ...
          {activeTab === 'document' && (
            <div className="dashboard-card" style={{ maxWidth: '900px', margin: '0 auto' }}>
              <div className="card-header">
                <h3 className="card-title">💳 Seized Bank Passbook/Cheque Analyzer (AI #6)</h3>
                <span className="badge badge-blue">Zia Identity Scanner</span>
              </div>
              <p style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '20px' }}>
                Upload photos of seized financial records. Zia Identity Scanner extracts transactions, banks, names, and flags anomalous flow patterns (like Hawala transactions).
              </p>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '24px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div className="dropzone" style={{ padding: '30px 10px' }} onClick={handleDocScan}>
                    ...
                    <span style={{ fontSize: '13px', fontWeight: 600 }}>Capture or Upload Passbook</span>
                  </div>
                  <button className="btn btn-primary" onClick={handleDocScan} disabled={docLoading}>
                    {docLoading ? <span className="spinner"></span> : 'Scan Seized Record'}
                  </button>

                  {docResult && (
                    <div style={{ background: 'rgba(255, 255, 255, 0.02)', padding: '14px', borderRadius: '8px', border: '1px solid var(--card-border)', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  ...
                  {docResult ? (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      ...
                      <div className="risk-banner">
                        ...
                        <div>
                          <p style={{ fontWeight: 600 }}>Hawala Pattern Flag</p>
                          <p style={{ fontSize: '11px', color: '#fecdd3' }}>{docResult.riskPatternFlag}</p>
                        </div>
                      </div>
                    </div>
                  ) : (
                    <div style={{ border: '1px dashed var(--card-border)', borderRadius: '8px', padding: '40px', textAlign: 'center', color: 'var(--text-muted)', fontSize: '13px' }}>
                      Click "Scan Seized Record" to extract financial nodes.
                    </div>
                  )}
                </div>
              </div>
          ...
          {activeTab === 'similarity' && (
            <div className="dashboard-card" style={{ maxWidth: '800px', margin: '0 auto' }}>
              <div className="card-header">
                <h3 className="card-title">⚖️ Modus Operandi Pattern Matching Engine (AI #7)</h3>
                <span className="badge badge-blue">QuickML Embeddings</span>
              </div>
              <p style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '20px' }}>
                Compare modus operandi characteristics (entry method, time, victim profiles) against historical records to link serial offenses across stations.
              </p>
              ...
              <div className="similarity-box">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', background: 'rgba(255, 255, 255, 0.01)', padding: '16px', borderRadius: '8px', border: '1px solid var(--card-border)' }}>
                ...
                <div>
                  ...
                  {similarityMatches.length > 0 ? (
                    ...
                    <div style={{ border: '1px dashed var(--card-border)', borderRadius: '8px', padding: '40px', textAlign: 'center', color: 'var(--text-muted)', fontSize: '13px' }}>
                      Trigger "Scan for Case Linkages" to run QuickML Mo similarity algorithms.
                    </div>
                  )}
                </div>
              </div>
          ...
          {activeTab === 'graph' && (
            <div className="ocr-split">
              ...
              <div className="graph-pane" style={{ height: '100%' }}>
                <h3 style={{ fontSize: '16px', fontWeight: 600, marginBottom: '6px' }}>🕸️ Accused Network & co-offending Link Map (AI #8)</h3>
                <p style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '16px' }}>
                  Interactive network link visualization. {graphLinks.length} connections analyzed. Click any node to inspect relationships, phone numbers, vehicle links, and degree centrality.
                </p>
                ...
                {graphLoading ? (
                  ...
                  <div className="graph-canvas">
                    ...
                    <svg width="100%" height="100%" viewBox="0 0 600 400" style={{ cursor: 'grab' }}>
                      ...
                      {/* Links */}
                      <line x1="300" y1="200" x2="150" y2="120" stroke="rgba(255,255,255,0.2)" strokeWidth="2" />
                      <line x1="300" y1="200" x2="300" y2="80" stroke="rgba(255,255,255,0.2)" strokeWidth="2" />
                      <line x1="300" y1="200" x2="450" y2="150" stroke="rgba(255,255,255,0.2)" strokeWidth="2" />
                      <line x1="150" y1="120" x2="100" y2="280" stroke="rgba(255,255,255,0.2)" strokeWidth="2" />
                      <line x1="300" y1="80" x2="500" y2="280" stroke="rgba(255,255,255,0.2)" strokeWidth="2" />
                      ...
                      <text x="300" y="230" fill="white" fontSize="11" textAnchor="middle" fontWeight="bold">Shiva (Accused)</text>
                      ...
                      <text x="300" y="60" fill="#fca5a5" fontSize="11" textAnchor="middle" fontWeight="bold">Ali Baig (Broker)</text>
              ...
              <div className="ocr-pane">
                <h3 style={{ fontSize: '16px', fontWeight: 600 }}>ℹ️ Node Inspector & Network Metrics</h3>
                ...
                {selectedNode ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <div>
                      <h4 style={{ fontSize: '13px', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '8px' }}>Centrality Metrics (SNA Algorithms):</h4>
                    ...
                    <div style={{ background: 'rgba(59, 130, 246, 0.05)', border: '1px solid rgba(59, 130, 246, 0.2)', padding: '14px', borderRadius: '8px', fontSize: '12px' }}>
                      <p style={{ fontWeight: 600, color: 'var(--accent-cyan)', marginBottom: '4px' }}>💡 Analytical Suggestion</p>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flexGrow: 1, color: 'var(--text-muted)' }}>
                    <span>Click any node in the connection graph map to inspect degrees and centrality indices.</span>
                  </div>
                )}
              </div>
            </div>
